[tml-server-v1-plugin-aefa-ml_agenticai_restapi] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [tml-server-v1-plugin-aefa-ml_agenticai_restapi] container is NOT running**.

.. tip::
   You must have your [tml-server-v1-plugin-aefa-ml_agenticai_restapi] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   Refer to the original solution container and documenation here: https://tml-server-v1-plugin-3f10-ml_agenticai_restapi.readthedocs.io/en/latest/operating.html
...
.. code-block::
   ...
   docker run -d --net=host -p 5050:5050 -p 4040:4040 -p 6060:6060 -p 9002:9002 \
          --env TSS=0 \
          --env SOLUTIONNAME=tml-server-v1-plugin-aefa-ml_agenticai_restapi \
          --env SOLUTIONDAG=solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa \
          ...
          /tml-server-v1-plugin-aefa-ml_agenticai_restapi-amd64
...
[tml-server-v1-plugin-aefa-ml_agenticai_restapi] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/tsstmldemo/tsstmldemo/tree/main/tml-airflow/dags/tml-solutions/tml-server-v1-plugin-aefa
...
.. important::
   solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=33927, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33303, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45905, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35673, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41645, HPDEHOST=127.0.1.1, HPDEPORT=40561, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35629

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3716-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-preprocess-1521-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-ml-3533-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-predict-8047-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-ai-2817-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-agenticai-4483-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
