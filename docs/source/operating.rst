...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37389, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43189, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45499, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43587, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=42865, HPDEHOST=127.0.1.1, HPDEPORT=41107, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42357

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5430-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-preprocess-8458-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-ml-9254-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-predict-4100-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
