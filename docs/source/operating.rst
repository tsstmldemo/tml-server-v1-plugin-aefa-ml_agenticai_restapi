...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38921, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36821, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=39061, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33119, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=39913, HPDEHOST=127.0.1.1, HPDEPORT=34669, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=39787

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1862-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-preprocess-3261-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-ml-7445-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, python-predict-738-tml-server-v1-plugin-aefa-ml_agenticai_restapi,solution_preprocessing_ml_agenticai_restapi_dag-tml-server-v1-plugin-aefa, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-preprocess-agenticai, viper-ml, viper-predict
